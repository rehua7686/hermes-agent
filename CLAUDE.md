# Claude Instructions — go-workflow

Follow `AGENTS.md`. This file exists so Claude-style agents can discover the same repo-local workflow without Hermes-specific context.
...
python3 scripts/next_task.py --claim --agent claude
```
