# Full pre-slim runbook (20260503-085459)

Original SKILL.md body preserved before prompt-slimming. Use this as the detailed fallback reference; keep the main SKILL.md as the routing/hard-rules layer.
