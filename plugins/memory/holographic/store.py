...
class MemoryStore:
    ...
    def _init_db(self) -> None:
        ...
        if "ingestion_time" not in columns:
            self._conn.execute("ALTER TABLE facts ADD COLUMN ingestion_time TIMESTAMP")
            self._conn.execute("UPDATE facts SET ingestion_time = CURRENT_TIMESTAMP WHERE ingestion_time IS NULL")
