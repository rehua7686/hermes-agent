...
export const es: Translations = {
  ...
  channels: {
    ...
    gatewayNotRunning: "El gateway no se está ejecutando. Configura los canales aquí y luego inicia el gateway con hermes gateway start o con el botón Reiniciar de arriba.",
