...
export const zh: Translations = {
  common: {
    ...
    gateway: "网关",
    gatewayHint:
      "消息平台、API 服务器和 Webhook 在「频道」页面配置。这里是网关级别的设置（代理/中继模式以及全局允许列表）。",
    pluginLoadFailed:
  ...
  profiles: {
    ...
    invalidName: "配置档案名称非法",
    cloneFromDefault: "从默认配置档案克隆配置",
    allProfiles: "配置档案列表",
    noProfiles: "暂无配置档案。",
    defaultBadge: "默认",
    hasEnv: "已配置 env",
    ...
    confirmDeleteMessage:
      "将永久删除配置档案 '{name}' — 包括配置、密钥、记忆、会话、技能、定时任务。此操作无法撤销。",
    created: "已创建",
    deleted: "已删除",
    renamed: "已重命名",
  ...
  kanban: {
    ...
    noTasks: "— 无任务 —",
    unassigned: "未分配",
    needsAssignee: "需指定负责人",
    needsAssigneeHint:
      "依赖项已满足，但调度器会跳过此任务，直到你为其分配一个配置档案。",
    untitled: "（无标题）",
    loadingDetail: "加载中…",
    ...
    confirmBlocked:
      "将此任务标记为阻塞？工作者将被释放。",
    confirmScheduled:
      "将此任务移到「已调度」？请在已知时间延迟（而非人工阻塞）时使用。",
    completionSummary:
