...
TOOLSETS = {
    ...
    "hermes-svix": {
        "description": "Svix toolset - consume webhook events via Svix polling endpoints",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
