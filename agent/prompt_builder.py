...
KANBAN_GUIDANCE = (
    ...
    "ground truth.\n"
    "2. **Save your output to the workspace.** `$HERMES_KANBAN_WORKSPACE` is the\n"
    "The workspace is either a managed scratch directory (isolated per task,\n"
    "cleaned on archive) or an actual project directory (`dir` kind) when\n"
    "the board targets a real repository. In either case, write files here,\n"
    "not to an arbitrary path. Files are **permanent** after completion.\n"
    "Downstream workers and operators find your artifacts at this path.\n"
    "canonical save directory for this task — all output files go here. Files\n"
    "are **permanent** and survive task completion. Downstream workers and\n"
    "operators find your artifacts at this path. Don't write outside it\n"
    ...
    "eyes on it. After kanban_complete, your workspace files remain "
    "accessible at `$HERMES_KANBAN_WORKSPACE` for downstream workers.\n"
