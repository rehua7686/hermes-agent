---
title: "Watchers — опрашивать RSS, JSON API и GitHub с удалением дубликатов водяного знака"
sidebar_label: "Watchers"
description: "Опрос RSS, JSON API и GitHub с удалением дубликатов по водяному знаку"
---
