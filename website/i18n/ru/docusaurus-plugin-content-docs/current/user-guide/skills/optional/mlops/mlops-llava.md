---
title: "Llava — большой языковой и визуальный помощник"
sidebar_label: "Llava"
description: "Большой языковой и визуальный ассистент"
---
...
Большой языковой и визуальный помощник. Позволяет выполнять настройку инструкций с визуальными данными и вести диалоги, основанные на изображениях. Объединяет визуальный энкодер CLIP с языковыми моделями Vicuna/LLaMA. Поддерживает многократный чат с изображениями, визуальный вопрос‑ответ и следование инструкциям. Используется для чат‑ботов «визуальный язык» или задач понимания изображений. Наилучший вариант для разговорного анализа изображений.
...
Открытая модель «визуальный язык» для разговорного понимания изображений.
...
1. **Hallucinations** — May describe things not present in the image
...
5. **VRAM requirements** — Need a powerful GPU
