---
title: "Weights And Biases — W&B: журналировать ML‑эксперименты, sweeps, реестр моделей, дашборды"
sidebar_label: "Weights And Biases"
description: "W&B: вести журнал ML‑экспериментов, sweeps, реестр моделей, панели мониторинга"
---
...
W&B: логировать ML‑эксперименты, sweeps, реестр моделей, дашборды.
...
Используй Weights & Biases (W&B), когда нужно:
...
- **Управлять реестром моделей** с версионированием и наследованием
- **Сотрудничать в ML‑проектах** через командные рабочие пространства
- **Отслеживать артефакты** (датасеты, модели, код) с наследованием

**Пользователи**: более 200 000 ML‑специалистов | **GitHub Stars**: более 10,5 k | **Интеграции**: более 100
...
**Project**: набор связанных экспериментов
**Run**: отдельный запуск твоего скрипта обучения
...
### 2. Отслеживание конфигураций

Отслеживай гиперпараметры автоматически:
...
Отслеживай датасеты, модели и другие файлы с наследованием.
...
Создавай совместно используемые отчёты в UI W&B:
- Объединяй запуски, графики и текст
- Поддержка Markdown
...
### 1. Организуй с помощью тегов и групп
...
### 5. Используй офлайн‑режим при нестабильных соединениях
...
- Создай командный аккаунт на wandb.ai
- Добавь участников команды
- Установи видимость проекта (private/public)
- Используй артефакты и реестр моделей уровня команды

## Ценообразование

- **Free**: неограниченные публичные проекты, 100 GB хранилища
- **Academic**: бесплатно для студентов/исследователей
- **Teams**: $50 за место в месяц, приватные проекты, неограниченное хранилище
- **Enterprise**: индивидуальная цена, варианты on‑prem
