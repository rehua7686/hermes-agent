---
title: "Github Issues — Создавай, сортируй, помечай, назначай задачи GitHub через gh или REST"
sidebar_label: "Github Issues"
description: "Создавай, сортируй, помечай, назначай задачи GitHub через gh или REST"
---
...
Создавай, триажь, помечай, назначай issues GitHub через `gh` или REST.
