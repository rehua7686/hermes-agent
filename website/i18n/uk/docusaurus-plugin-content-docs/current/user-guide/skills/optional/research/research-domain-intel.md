---
title: "Domain Intel — Пасивне розвідка домену за допомогою Python stdlib"
sidebar_label: "Domain Intel"
description: "Пасивне розвідка домену за допомогою Python stdlib"
---

\{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */\}

# Domain Intelligence — Пасивний OSINT

Пасивна розвідка домену за допомогою лише стандартної бібліотеки Python.
**Нуль залежностей. Нуль API‑ключів. Працює на Linux, macOS та Windows.**
...
## Коли використовувати цю навичку замість вбудованих інструментів
