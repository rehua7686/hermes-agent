---
title: "Nemo Curator — GPU-акселерована обробка даних для навчання LLM"
sidebar_label: "Nemo Curator"
description: "GPU-акселерована підготовка даних для навчання LLM"
---
...
GPU-акселерована обробка даних для навчання LLM. Підтримує текст/зображення/відео/аудіо. Має нечітку дедуплікацію (16× швидше), фільтрацію за якістю (30+ евристик), семантичну дедуплікацію, видалення PII, виявлення NSFW‑контенту. Масштабується на кілька GPU за допомогою RAPIDS. Використовуй для підготовки високоякісних навчальних наборів даних, очищення веб‑даних або дедуплікації великих корпусів.
