---
title: "Modal Serverless Gpu — хмарна платформа Serverless GPU для запуску навантажень ML"
sidebar_label: "Modal Serverless Gpu"
description: "Безсерверна GPU хмарна платформа для запуску ML навантажень"
---
...
Комплексний посібник з запуску ML‑навантажень на безсерверній GPU‑хмарі Modal.

## Коли використовувати Modal

**Використовуй Modal, коли:**
- Запускаєш GPU‑інтенсивні ML‑навантаження без управління інфраструктурою
- Розгортаєш ML‑моделі як авто‑масштабовані API
- Потрібна обробка пакетних завдань (тренування, інференс, обробка даних)
- Потрібне ціноутворення pay‑per‑second без простоїв
- Швидко прототипуєш ML‑додатки
- Потрібні заплановані завдання (на кшталт cron)
