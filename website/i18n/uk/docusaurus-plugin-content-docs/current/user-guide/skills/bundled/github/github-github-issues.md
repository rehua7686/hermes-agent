---
title: "Github Issues — створювати, сортувати, позначати мітками, призначати Github issues через gh або REST"
sidebar_label: "Github Issues"
description: "Створюй, сортуй, позначай, призначай GitHub‑задачі за допомогою gh або REST."
---
...
Створюй, фільтруй, позначай мітками, призначай GitHub‑issues за допомогою `gh` або REST.
...
Створюй, шукай, фільтруй та керуй GitHub‑issues. Кожен розділ спочатку показує `gh`, потім запасний (фолбек) `curl`.
