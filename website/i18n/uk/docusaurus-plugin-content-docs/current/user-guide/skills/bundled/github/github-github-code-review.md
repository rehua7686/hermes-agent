---
title: "Github Code Review — Перегляд PR: дифі, інлайн‑коментарі через gh або REST"
sidebar_label: "Github Code Review"
description: "Переглядай PR‑и: дифі, інлайн‑коментарі через gh або REST"
---

\{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */\}

# Огляд коду на GitHub

Перегляд PR: diff, інлайн‑коментарі через **gh** або REST.
...
When the user asks you to “review PR #N”, “look at this PR”, or provides a PR URL, follow this recipe:
