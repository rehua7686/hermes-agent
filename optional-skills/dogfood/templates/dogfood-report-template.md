...
**Screenshot:**
{Use `MEDIA:<screenshot_path>` on messaging platforms that support media attachments. In CLI/terminal output, use the plain local screenshot path without a `MEDIA:` prefix.}
