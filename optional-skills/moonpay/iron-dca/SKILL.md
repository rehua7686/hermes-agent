---
name: iron-dca
description: "Wire fiat to your Iron virtual account. Agent detects the deposit, splits it into equal chunks, and automatically DCA's into any token on a daily schedule. Full loop from bank wire to on-chain position — no manual steps."
version: 0.1.0
