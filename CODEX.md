# Codex Instructions — go-workflow

Follow `AGENTS.md`. This file exists so Codex-style agents can discover the same repo-local workflow without Hermes-specific context.
